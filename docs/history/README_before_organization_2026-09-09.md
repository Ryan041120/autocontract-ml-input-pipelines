> 历史 README，保存于 2026-09-09 整理时。正文保留此前各阶段叙述；链接已适配新位置。旧命令是历史说明，不代表当前执行授权。最新进展见 [CURRENT_STATE](../../CURRENT_STATE.md)。
...
- `docs/background/cachew_pecan_选题备忘录.md`: the original broad-direction
